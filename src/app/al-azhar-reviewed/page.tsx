...
import books from '@/data/al-azhar-books.json';

export const metadata: Metadata = {
  title: 'Al-Azhar Reviewed Books — Success in Eternity',
  description:
    'Books by Dr. Mamdouh Salama that have been scholarly reviewed by professors of Al-Azhar University.',
};

export default function AlAzharReviewedPage() {
  return (
    <div className="container-site py-12">
      ...
      <div className="mb-8 pb-6 border-b" style={{ borderColor: 'var(--color-border)' }}>
        ...
        >
          Al-Azhar Reviewed Books
        </h1>
        <p className="text-sm mt-2" style={{ color: 'var(--color-muted)' }}>
          {books.length} book{books.length !== 1 ? 's' : ''} reviewed by Al-Azhar University
        </p>
      </div>
      ...
      >
        ...
        <p className="text-sm" style={{ color: 'var(--color-ink)' }}>
          These books by Dr. Mamdouh Salama have been scholarly reviewed and endorsed by
          professors of Al-Azhar University, one of the world's leading institutions of Islamic learning.
        </p>
      </div>
